                                ...
                                <tbody>
                                    @forelse ($data as $pembayaran)
                                        <tr>
                                            ...
                                            {{-- <td scope="col"><b>Spp </b>{{ substr($pembayaran->spp->tahun_keluar, 0, 4) }}
                                                -{{ substr($pembayaran->spp->tahun_keluar, -4, 4) }}</td> --}}
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" style="color: whitesmoke"
                                                class="bg-danger text-bold text-center">Belum terdapat data apapaun <i
                                                    class="fas fa-sad-cry"></i></td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
